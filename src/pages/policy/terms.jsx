...
export default function Terms() {
    return (
        <>
            <Head><title>Terms of Use | Health In Transportation</title></Head>
            <div id="Terms" className={ styles.policy }>
                ...
                Use are posted. <br /><br /> The information provided on the Site is not intended for distribution to or use by
                ...
                <h2>SITE MANAGEMENT</h2> We reserve the
                right, but not the obligation, to: (1) monitor the Site for violations of these Terms of Use; (2) take
                ...
                be construed to obligate us to maintain and support the Site or to supply any corrections, updates, or
                releases in connection therewith.

                <h2>GOVERNING LAW</h2>These Terms of Use and your use of the Site
                are governed by and construed in accordance with the laws of the State of Tennessee applicable to agreements
                made and to be entirely performed within the State of Tennessee conflict of law principles.

                <h2>DISPUTE RESOLUTION</h2>
                <h3>Binding Arbitration</h3>If the Parties are unable to resolve a Dispute through
                ...
                AAA&rsquo;s Supplementary Procedures for Consumer Related Disputes (&quot;AAA Consumer Rules&quot;), both of which are
                ...
                arbitration will take place in Hamilton County, Tennessee. Except as otherwise provided herein, the
                Parties may litigate in court to compel arbitration, stay proceedings pending arbitration, or to confirm,
                modify, vacate, or enter judgment on the award entered by the arbitrator.<br /><br /> If for any reason, a
                Dispute proceeds in court rather than arbitration, the Dispute shall be commenced or prosecuted in the state
                and federal courts located in Hamilton County, Tennessee, and the Parties hereby consent to, and waive all
                defenses of lack of personal jurisdiction, and forum non conveniens with respect to venue and jurisdiction
                in such state and federal courts. Application of the United Nations Convention on Contracts for the
                International Sale of Goods and the Uniform Computer Information Transaction Act (UCITA) are excluded from
                these Terms of Use.<br /><br /> If this provision is found to be illegal or unenforceable, then neither Party
                ...
                <h2>Restrictions</h2> The Parties agree that any arbitration shall be limited to the Dispute
                ...
                <h2>Exceptions to Arbitration</h2>The Parties agree that the following Disputes are not
                subject to the above provisions concerning binding arbitration: (a) any Disputes seeking to enforce or
                ...
                <h2>INDEMNIFICATION</h2>You agree to defend, indemnify, and hold us harmless, including our subsidiaries,
                ...
                your representations and warranties set forth in these Terms of Use; (4) your violation of the rights of a
                ...
                <h2>USER DATA</h2>We will maintain certain data that you
                transmit to the Site for the purpose of managing the performance of the Site, as well as data relating to
                your use of the Site. Although we perform regular routine backups of data, you are solely responsible for all
                data that you transmit or that relates to any activity you have undertaken using the Site. You agree that I
                shall have no liability to you for any loss or corruption of any such data, and you hereby waive any right
                of action against us arising from any such loss or corruption of such data.

                <h2>ELECTRONIC
                    COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</h2> Visiting the Site, sending us emails & text messages, and completing
                ...
                <h2>CALIFORNIA USERS AND
                    RESIDENTS</h2>If any complaint with us is not satisfactorily resolved, you can contact the Complaint
