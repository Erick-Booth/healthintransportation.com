...
export default function Privacy() {
    return (
        <>
            <Head><title>Privacy Policy | Health In Transportation</title></Head>
            <div id="Privacy Policy" className={ styles.policy }>
                ...
                sharing your personal information with us.<br /><br />
                <h2>TABLE OF CONTENTS</h2>
                <ol>
                    <li><a href="#1">WHAT INFORMATION DO WE COLLECT?</a></li>
                    <li><a href="#2">WILL YOUR INFORMATION BE SHARED WITH ANYONE?</a></li>
                    <li><a href="#3">DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</a></li>
                ...
                The personal information that we collect depends on the context of your interactions with me
                ...
                We automatically collect certain information when you visit, use or navigate the Site. This
                information does not reveal your specific identity (like your name or contact information) but
                may include device and message information, such as your IP address, browser and device
                ...
                <h2 id='2'>2. WILL YOUR INFORMATION BE SHARED WITH ANYONE?</h2>
                ...
                <ul>
                    <li>Consent: we may process your
                    ...
                    <li>Performance of a Contract: Where we have entered into a contract with you, we may process your
                        personal information to fulfill the terms of our contract.</li>
                    ...
                    <li>Legal Obligations: we may disclose your information where we are legally required to do so in
                        ...
                        order, or legal process, such as in response to a court order or a subpoena.</li>
                    ...
                    <li>Vital Interests: we may disclose your information where we believe it is necessary to investigate,
                        ...
                        evidence in litigation in which we are involved. More specifically, we may need to process your
                        ...
                        <ul>
                            <li>
                                ...
                                marketing efforts. We may allow selected third parties to use tracking technology on the site,
                                which will enable them to collect data about how you interact with the over time. This
                        ...
                        Unless described in this Policy, we do not share, sell, rent, or trade any of your information with third parties for their
                        promotional purposes.
                    </li>
                    <li>Business Transfers. We may share or transfer your information in connection with, or during
                        negotiations of, any merger, sale of Brand assets, financing, or acquisition of all or a portion of
                        our business to another Brand.</li>
                    <li>Third-Party Advertisers. We may use third-party advertising companies to serve ads when you
                        visit the Site. These companies may use information about your visits to our website(s) and other
                        websites that are contained in web cookies and other tracking technologies in order to
                        provide advertisements about goods and services of interest to you.</li>
                    <li>Affiliates. We may share your information with our affiliates, in which case we will require those
                        affiliates to honor this privacy policy. Affiliates include our parent Brand and any subsidiaries,
                    ...
                    <li>Other users. When you share personal information or otherwise interact with public areas of
                        the website, such personal information may be viewed by all users and may be publicly
                        distributed outside the in perpetuity. If you interact with other users of our website and
                        register through a social network (such as Facebook), your contacts on the social network will
                        see your name, profile photo, and descriptions of your activity. Similarly, other users will be
                        able to view descriptions of your activity, communicate with you within our website, and view
                        your profile.</li>
                </ul>

                <h2 id='3'>3. DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</h2>
                ...
                <h2 id='4'>4. HOW DO WE HANDLE YOUR SOCIAL LOGINS?</h2>
                ...
                policy or that are otherwise made clear to you on the Site. Please note that we do not control, and
                are not responsible for, other uses of your personal information by your third-party social
                ...
                <h2 id='5'>5. IS YOUR INFORMATION TRANSFERRED INTERNATIONALLY?</h2>
                In Short: we may transfer, store, and process your information in countries other than your own.
                Currently, our servers are located in the United States. If you are accessing our website from
                outside this region, please be aware that your information may be transferred to, stored, and
                processed by us in our designated facilities and by those third parties with whom we may
                share your personal information (see &quot;WILL YOUR INFORMATION BE SHARED WITH ANYONE?&quot;
                above), in and other countries.<br /><br />
                ...
                <h2 id='6'>6. WHAT IS OUR STANCE ON THIRD-PARTY WEBSITES?</h2>
                ...
                They may contain advertisements from third parties that are not affiliated with me, and which
                may link to other websites, online services, or mobile applications. We cannot guarantee the
                safety and privacy of data you provide to any third parties. Any data collected by third
                parties is not covered by this privacy policy. We are not responsible for the content or privacy
                and security practices and policies of any third parties, including other websites, services or
                applications that may be linked to or from the Site. You should review the policies of such third
                ...
                <h2 id='8'>8. DO WE COLLECT INFORMATION FROM MINORS?</h2>
                In Short: we do not knowingly collect data from or market to children under 18 years of age.
                We do not knowingly solicit data from or market to children under 18 years of age. By using the
                website, you represent that you are at least 18 or that you are the parent or guardian of such
                a minor and consent to such minor dependent’s use of the Site. If we learn that personal
                ...
                <h2 id='11'>11. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</h2>
                In Short: Yes, if you are a resident of California, you are granted specific rights regarding
                access to your personal information. Please note that we do not typically conduct business of
                any sort in California.<br /><br />
                California Civil Code Section 1798.83, also known as the “Shine The Light” law, permits our
                users who are California residents to request and obtain from me, once a year and free of
                ...
                writing to using the contact information provided below.
                If you are under 18 years of age, reside in California, and have a registered account with the
                website, you have the right to request removal of unwanted data that you publicly post on
                the Site. To request removal of such data, please contact us using the contact information
                ...
                the site, but please be aware that the data may not be completely or comprehensively
                removed from our systems.

                <h2 id='12'>12. DO WE MAKE UPDATES TO THIS POLICY?</h2>
                ...
                submit a request by email, or by using our <a href={ `https://www.healthintransportation.com/contact` }>contact form</a>. We will respond to your request at our
